# Contributing to Type Utils ❇️

We’re excited that you’re interested in contributing to Type Utils! This guide will help you get started.
...
- Go to the [repository page](https://github.com/alessiofrittoli/type-utils).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/type-utils.git
```
...
Thank you for helping improve Type Utils! 🎉